        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_year_number",
                    models.PositiveSmallIntegerField(
                        choices=[(2020, 2020), (2021, 2021)], default=2020
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "year_number",
                    models.PositiveSmallIntegerField(
                        choices=[(2020, 2020), (2021, 2021)], default=2021
                    ),
                ),
                (
                    "station",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="month_data",
                        to="eco_counter.month",
                    ),
                ),
                (
                    "station",
