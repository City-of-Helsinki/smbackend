...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('language', models.CharField(max_length=10, db_index=True, choices=[('fi', 'Finnish'), ('sv', 'Swedish'), ('en', 'English')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_fi', models.CharField(max_length=200, blank=True, null=True, db_index=True)),
                ('name_sv', models.CharField(max_length=200, blank=True, null=True, db_index=True)),
                ('name_en', models.CharField(max_length=200, blank=True, null=True, db_index=True)),
                ('abbr', models.CharField(max_length=50, blank=True, null=True, db_index=True)),
                ('abbr_fi', models.CharField(max_length=50, blank=True, null=True, db_index=True)),
                ('abbr_sv', models.CharField(max_length=50, blank=True, null=True, db_index=True)),
                ('abbr_en', models.CharField(max_length=50, blank=True, null=True, db_index=True)),
                ('street_address', models.CharField(max_length=100, blank=True, null=True)),
                ('street_address_fi', models.CharField(max_length=100, blank=True, null=True)),
                ('street_address_sv', models.CharField(max_length=100, blank=True, null=True)),
                ('street_address_en', models.CharField(max_length=100, blank=True, null=True)),
                ('address_city', models.CharField(max_length=100, blank=True, null=True)),
                ('address_city_fi', models.CharField(max_length=100, blank=True, null=True)),
                ('address_city_sv', models.CharField(max_length=100, blank=True, null=True)),
                ('address_city_en', models.CharField(max_length=100, blank=True, null=True)),
                ('address_postal_full', models.CharField(max_length=200, blank=True, null=True)),
                ('address_postal_full_fi', models.CharField(max_length=200, blank=True, null=True)),
                ('address_postal_full_sv', models.CharField(max_length=200, blank=True, null=True)),
                ('address_postal_full_en', models.CharField(max_length=200, blank=True, null=True)),
                ...
                ('object_identifier', models.CharField(max_length=20, blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Service',
