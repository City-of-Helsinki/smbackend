...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, auto_created=True, verbose_name='ID', primary_key=True)),
                ('language', models.CharField(max_length=10, choices=[('fi', 'Finnish'), ('sv', 'Swedish'), ('en', 'English')], db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connection_hash', models.CharField(max_length=40, null=True, help_text='Automatically generated hash of connection info')),
                ('accessibility_property_hash', models.CharField(max_length=40, null=True, help_text='Automatically generated hash of accessibility property info')),
