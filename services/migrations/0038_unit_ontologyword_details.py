    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ontologyword', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unit_details', to='services.OntologyWord')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ontologyword_details', to='services.Unit'),
        ),
        migrations.AddField(
            model_name='unit',
            name='ontologywords',
            field=models.ManyToManyField(related_name='units', through='services.UnitOntologyWordDetails', to='services.OntologyWord'),
        ),
