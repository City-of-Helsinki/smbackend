...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.identical_to'
        db.add_column('services_service', 'identical_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service'], null=True, related_name='duplicates'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.identical_to'
        db.delete_column('services_service', 'identical_to_id')
    ...
    models = {
        ...
        'munigeo.municipality': {
            ...
            'division': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['munigeo.AdministrativeDivision']", 'unique': 'True', 'null': 'True', 'related_name': "'muni'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '100', 'db_index': 'True'}),
            'name_en': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '100', 'db_index': 'True'}),
            'name_fi': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '100', 'db_index': 'True'}),
        ...
        'services.service': {
            ...
            'identical_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['services.Service']", 'null': 'True', 'related_name': "'duplicates'"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200'}),
            'name_en': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '200', 'db_index': 'True'}),
            'name_fi': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '200', 'db_index': 'True'}),
            'name_sv': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '200', 'db_index': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['services.Service']", 'null': 'True', 'related_name': "'children'"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
        'services.unit': {
