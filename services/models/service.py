...
class Service(models.Model):
    ...
    root_service_node = models.ForeignKey('ServiceNode', null=True, on_delete=models.CASCADE)
...
class UnitServiceDetails(models.Model):
    unit = models.ForeignKey('Unit', db_index=True, related_name='service_details', on_delete=models.CASCADE)
    service = models.ForeignKey('Service', db_index=True, related_name='unit_details', on_delete=models.CASCADE)
