...
@extend_schema(
    parameters=[
        ...
        OpenApiParameter(
            name="distance",
            location=OpenApiParameter.QUERY,
            description="The maximum distance from the provided location, defined by the lat and lon parameters. "
            "If this parameter is given also the 'lat' and 'lon' parameters are required.",
            required=False,
            type=float,
        ),
        OpenApiParameter(
            ...
            "Values must be floating points or integers.",
            required=False,
            type=str,
        ),
    ],
